...
DirWalker.prototype.walk = function (dir, options) {
  ...
  async.waterfall([
        ...
        function (cb) {
          _walk.call(self, dir, null, options, cb);
        }
      ],
 ...
 * @private
 */
function _walk(dir, parent, options, callback) {
  var recurse = options && (options.recurse || options.recursive),
      entries = [],
      entry,
      pathname,
      isDirectory,
  ...
  _loadIgnoreFiles.call(this, dir, function (err, filters) {
    ...
    filters = _.union(_getDefaultIgnore.call(this), filters);
          ...
          function (file, cb) {
            ...
            fs.stat(pathname, function (err, stats) {
              ...
              if (isDirectory && recurse) {
                ...
                return _walk.call(this, entry.pathname, path.join(parent || '', entry.basename), options, cb);
              }
